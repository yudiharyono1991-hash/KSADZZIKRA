    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Kelola data cabang KSA Mart, QRIS per-cabang, dan metode pembayaran</p>
        </div>
        {isGlobalAdmin && (
          <button
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredBranches.map(branch => (
                <tr key={branch.id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-4 text-gray-600 text-xs max-w-[200px] truncate">{branch.address}</td>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
            {/* Modal Header */}
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-green-600 to-emerald-600 text-white">
            ...
            <form onSubmit={handleSubmit}>
              <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
                ...
                {activeSection === 'info' && (
                  <>
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Nama Cabang <span className="text-red-500">*</span></label>
                      <input
                        type="text"
                        required
                        value={formData.name}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Nomor Telepon <span className="text-red-500">*</span></label>
                        <input
                          type="text"
                          required
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      />
                      <label htmlFor="isActiveCbx" className="text-sm text-gray-700 font-medium">Cabang ini sedang <strong>Aktif</strong> beroperasi</label>
                    </div>
                  </>
                )}
                ...
                {activeSection === 'qris' && (
                    ...
                    {/* Upload Button */}
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">Upload Gambar QRIS Langsung</label>
                      <input
                        ref={qrisFileRef}
                        type="file"
                        accept="image/*"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">URL Gambar QRIS Cabang</label>
                      <input
                        type="url"
                    ...
                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center">
                      {formData.qrisImageUrl ? (
                        <div className="space-y-2">
                          ...
                          <img src={formData.qrisImageUrl} alt="Preview QRIS" className="w-40 h-40 object-contain mx-auto rounded-lg border border-gray-200 bg-white" />
                          <button
                            type="button"
