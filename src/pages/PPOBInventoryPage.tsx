              ...
              <form id="ppobForm" onSubmit={handleFormSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    <p className="text-[10px] text-gray-500 mt-1">Kosongkan jika harga berubah-ubah saat transaksi.</p>
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1 flex items-center gap-1">
                    ...
                    />
                    <p className="text-[10px] text-gray-500 mt-1">Kosongkan jika harga ditentukan saat di Kasir.</p>
                  </div>
                </div>
