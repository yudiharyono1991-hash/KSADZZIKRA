...
export default function NeracaRugiPage() {
  ...
  const handleExportCSV = () => {
    ...
    csvContent += "--- NERACA POSISI KEUANGAN ---\n";
    csvContent += "POS AKTIVA (ASET);Jumlah;POS PASIVA (LIABILITAS / MODAL);Jumlah\n";
    csvContent += `Kas Bersih Utama;Rp ${cashOnHand};Utang Dagang Agen;Rp ${accountsPayables}\n`;
    csvContent += `Persediaan Barang Dagang;Rp ${valueOfInventory};Modal Disetor Pemilik;Rp ${activeEquityValue}\n`;
    csvContent += `Piutang Pembeli Aktif;Rp ${receivablesVal};Laba Berjalan Bersih Ditahan;Rp ${allTimeProfit}\n`;
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3.5 text-xs">
              <div className="flex justify-between font-bold text-slate-800 bg-slate-50/80 px-3.5 py-2.5 rounded-lg border">
                <span>PENDAPATAN USAHA (OMSET PENJUALAN)</span>
              ...
              <div className="flex justify-between font-bold text-emerald-800 bg-emerald-50/40 px-3.5 py-2 rounded-lg border border-emerald-100/60">
                <span>LABA KOTOR PERDAGANGAN (MARGIN)</span>
          ...
          <div className="space-y-4 text-xs text-gray-700">
            ...
            <div className="bg-[#fafafa] p-4 rounded-xl border border-gray-200/60 space-y-3">
              <p className="font-black text-slate-800 tracking-wider text-[11px] border-b pb-1 flex justify-between items-center">
                <span>AKTIVA (ASET / HARTA TOKO)</span>
                <span className="text-[10px] text-emerald-700">Lancar & Inventaris</span>
              </p>

              <div className="space-y-2.5 text-xs">
                <div className="flex justify-between">
                  <span className="text-gray-500 font-medium">Kas Utama (Saldo Bersih Toko)</span>
                  <span className="font-mono font-semibold text-slate-900">Rp {cashOnHand.toLocaleString('id-ID')}</span>
                </div>
                
                <div className="flex justify-between">
                  <span className="text-gray-500 font-medium">Persediaan Barang Dagang (Valuation)</span>
                ...
                <div className="flex justify-between items-center bg-white p-2 rounded-lg border border-gray-150 shadow-2xs">
                  <span className="text-gray-650 font-bold">Piutang Pembeli Dagang:</span>
            ...
            <div className="bg-[#fafafa] p-4 rounded-xl border border-gray-200/60 space-y-3">
              <p className="font-black text-slate-800 tracking-wider text-[11px] border-b pb-1 flex justify-between items-center">
                ...
                <span className="text-[10px] text-blue-700">Liabilitas & Modal</span>
              </p>

              <div className="space-y-2.5 text-xs">
                <div className="flex justify-between items-center bg-white p-2 rounded-lg border border-gray-150 shadow-2xs">
                  <span className="text-gray-600 font-bold">Utang Dagang Agen:</span>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-2 flex items-center text-gray-400 font-mono text-[10px]">Rp</span>
                    <input 
                      type="number" 
                ...
                <div className="flex justify-between pt-1">
                  <span className="text-gray-500 font-medium">Laba Berjalan Bersih Ditahan (Sistem)</span>
