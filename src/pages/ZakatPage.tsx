...
export default function ZakatPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-200/85 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="font-extrabold text-gray-800 text-sm">Amanah Himpunan Zakat & ESG Dashboard</h2>
        ...
        <div className="bg-slate-50 p-1 rounded-xl border border-gray-200 flex space-x-1">
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in duration-200">
            ...
            <div className="space-y-4 text-xs font-semibold text-gray-600">
              ...
              <div className="grid grid-cols-2 gap-4 col-span-2">
                <div className="space-y-1">
                  <label className="text-xs font-extrabold text-gray-700 block">Acuan Harga Emas Standar (MUI/Realtime)</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Cash asset */}
                <div className="space-y-1">
                  <label className="text-gray-700">1. Kas Usaha & Saldo Bank Syariah</label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-2.5 flex items-center text-gray-300">Rp</span>
                    <input
                      type="number"
                      className="w-full border border-gray-200 rounded-lg py-2 pl-8 pr-3 font-mono"
                      value={cashAsset}
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Receivables asset */}
                <div className="space-y-1">
                  <label className="text-gray-700">3. Piutang Dagang Lancar</label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-2.5 flex items-center text-gray-300">Rp</span>
                    <input
                      type="number"
                ...
                {/* Liabilities */}
                <div className="space-y-1">
                  <label className="text-gray-700 text-red-700">4. Hutang Jatuh Tempo Kewajiban Dagang (-)</label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-2.5 flex items-center text-red-300">Rp</span>
                    <input
                      type="number"
                      className="w-full border border-gray-200 rounded-lg py-2 pl-8 pr-3 text-red-650 bg-red-50/20 font-mono"
              ...
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  className="w-full border border-gray-200 rounded-lg py-2 px-3 font-medium text-xs text-gray-850"
          ...
          <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-gray-200 shadow-xs flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <h3 className="font-extrabold text-gray-800 text-sm">Hasil Rekapitulasi Zakat Usaha</h3>
                <p className="text-[11px] text-gray-400 mt-0.5">Analisa kelayakan haul atas himpunan total harta dagang</p>
              </div>

              {/* Core Results Block */}
              <div className="space-y-3 font-medium text-xs text-gray-650 bg-slate-50 p-4 rounded-xl border border-gray-150">
                <div className="flex justify-between">
                  <span>Total Harta Dagang Lancar :</span>
                  <span className="font-bold text-gray-900 font-mono">Rp {(cashVal + inventoryVal + receivableVal).toLocaleString('id-ID')}</span>
                </div>
              ...
              {isEligible ? (
                ...
                <div className="bg-slate-50 text-slate-500 p-4 rounded-xl border border-gray-200 flex items-start space-x-2.5">
          ...
          <div className="lg:col-span-12 bg-white rounded-2xl border border-gray-200 shadow-xs overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse">
                <thead className="bg-[#f8fafc] uppercase tracking-widest text-[9px] text-gray-500 font-bold border-b border-gray-150">
                  <tr>
                ...
                <tbody className="divide-y divide-gray-100 text-gray-650 font-bold leading-normal">
                  {zakatRecords.length === 0 ? (
                    ...
                    zakatRecords.map((zk) => (
                      <tr key={zk.id} className="hover:bg-slate-50/50">
                        <td className="py-3 px-5 text-gray-500 font-semibold">{new Date(zk.timestamp).toLocaleString('id-ID')}</td>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in duration-200">
          ...
          <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-4 gap-4 select-none">
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200/80 shadow-xs">
              ...
              <h3 className="text-xl font-extrabold text-gray-800 mt-1 font-mono">Rp {totalZakatFromCalculations.toLocaleString('id-ID')}</h3>
            </div>
          ...
          <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-gray-200 shadow-xs space-y-4">
            ...
            <form onSubmit={handleSaveDistribution} className="space-y-4 text-xs font-semibold text-gray-600">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-lg py-2 pl-8 pr-3 font-mono text-gray-900"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-lg py-2 px-3 text-xs text-gray-850"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full border border-gray-200 rounded-lg py-1.5 px-3 text-xs text-gray-850 font-semibold"
                />
              </div>
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl border border-gray-200 shadow-xs overflow-hidden flex flex-col justify-between">
            <div>
              <div className="p-4 border-b border-gray-100 bg-slate-50 flex items-center justify-between">
                <h4 className="font-extrabold text-gray-800 text-xs">Penyaluran & Stewardship Program Log</h4>
                        ...
                        return (
                          <tr key={dist.id} className="hover:bg-slate-50/50">
                            <td className="py-3 px-4">
                              <p className="text-gray-900 font-extrabold">{dist.recipient}</p>
